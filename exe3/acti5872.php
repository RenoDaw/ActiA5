...
<head>
    ...
    <style>
        <?php
            if ($_SERVER['PHP_SELF'] == '/mirepo/exe3/acti5872.php')
                {   class pintar{
...
<body >
    ...
    <button class="button"><a style="text-decoration:none"  href='./acti5871.php'> Fes me Click per canviar de CSS</a> </button>
    <br>
    <br>
